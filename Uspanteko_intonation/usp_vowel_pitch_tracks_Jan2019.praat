...
header_text$ = "segment'tab$'code'tab$'word'tab$'start.time'tab$'token.code'tab$'interval.num'tab$'step'tab$'step.size'tab$'seg.dur'tab$'pitch.Hz'tab$'pitch.ERB'tab$'mean.pitch.Hz'tab$'mean.pitch.ERB'tab$'min.pitch.Hz'tab$'min.pitch.ERB'tab$'max.pitch.Hz'tab$'max.pitch.ERB'tab$'pitch.range.min'tab$'pitch.range.max'tab$'speaker"
